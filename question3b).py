...
RES, DYNODES = fonctions.relaxation(V, BLOQUER, PARAMETRES, variation=1e-5, max_iter=10000)

EX, EY, E_NORM = fonctions.champ_elec(RES, PARAMETRES)[0:3]

traj_x, traj_y = fonctions.position_el(X0, Y0, VY0, VY0, EX, EY, DT, IT_MAX, PARAMETRES)
